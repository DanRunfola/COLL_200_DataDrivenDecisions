...
\textbf {\large Discussions:} Most lecture sessions will begin with a brief discussion of the assigned materials.  As such, each week students will be asked to come to class prepared with two to three bullet points for discussion - these can represent questions the material raised, commentary, or critiques. \\
...
\begin{itemize} \itemsep-0.4em
	\vspace{1mm}
	\item 8/31 - Introduction and Computing Environment Setup
	\item Assignment 1 due midnight Tues Sept 12 - Defining and Simulating Uncertainty. 
	\vspace{1mm}
\end{itemize}
\end{minipage} \\
\hline
...
\begin{itemize} \itemsep-0.4em
	\vspace{1mm}
	\item 9/5 and 9/7 - Interactive Learning 
	\vspace{1mm}
\end{itemize}
\end{minipage} \\
\hline
...
\begin{itemize} \itemsep-0.4em
	...
	\item Assignment 2 due midnight Tues Sept 26 - Retrieving Data from Non-traditional Sources
	\vspace{1mm}
\end{itemize}
\end{minipage} \\
\hline
...
\begin{itemize} \itemsep-0.4em
	...
	\item Assignment 3 due midnight Friday October 13th - Integrating Disparate Data Sources
	\vspace{1mm}
\end{itemize}
\end{minipage} \\
\hline
...
\begin{itemize} \itemsep-0.4em
	...
	\item 10/19 - Data Visualization
	\item Assigment 4 due midnight Thursday 11/2 - Simulating a Solution
	\vspace{1mm}
\end{itemize}
\end{minipage} \\
\hline
...
\begin{itemize} \itemsep-0.4em
	...
	\item Assignment 5 due midnight Thursday 11/30 - Solution Set Optimization with Decisionmaker Input
	\vspace{1mm}
\end{itemize}
\end{minipage} \\
\hline
...
\begin{itemize} \itemsep-0.4em
	\vspace{1mm}
	\item 11/27 and11/30 - Communicating with Data
	\vspace{1mm}
\end{itemize}
\end{minipage} \\
\hline
